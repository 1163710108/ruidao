	...
	<body>
		<table width="100%" height="70%"  border="0" cellspacing="0" cellpadding="0">
			<tr>
				...
				<td width="100%" style="background-color:blue; ">
				 <span style="position:absolute;left: 20%;bottom:50%"><font style="font-family:方正舒体;font-size:400%;color:red">商城卖家管理系统</font></span>
				</td>
			</tr>
		</table>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td width="155" valign="bottom"
											background="${pageContext.request.contextPath}/images/mis_05b.jpg">
											用户名：
											<font color="blue">${login_shop.susername}</font>
											<button type="button" onclick="tuichudenglu()">
													退出</button>
										</td>
									</tr>
								</table>
